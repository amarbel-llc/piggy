...
//! JSON-RPC frontend an external TUI drives over a socket. The provisioning
//! engine (Phase 3b) will orchestrate `piggy card init`'s full setup against a
//! `&mut dyn Frontend`, staying agnostic to which binding is in use.
